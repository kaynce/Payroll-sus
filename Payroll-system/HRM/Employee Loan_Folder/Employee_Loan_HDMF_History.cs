...
namespace HRM
{
    public partial class Employee_Loan_HDMF_History : Form
    {
        ...
        public Employee_Loan_HDMF_History()
        {
            InitializeComponent();
            RetrieveData();
        }
        ...
        private void RetrieveData()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT * FROM P_Employee_Loan_HDMF_History", con);
        ...
        private void searchTxt_OnTextChange(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlDataAdapter dta = new SqlDataAdapter("SELECT * FROM P_Employee_Loan_HDMF_History WHERE Surname LIKE '" + search + "%'", con);
                DataTable dt = new DataTable();
                dta.Fill(dt);
                dataGridView1.DataSource = dt;
            }
